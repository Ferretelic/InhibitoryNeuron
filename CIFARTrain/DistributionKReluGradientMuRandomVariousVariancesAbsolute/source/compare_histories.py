...
def show_compare_histories(path_list, name_list, variance_list):
  accuracies = []
  losses = []
...
for i in np.linspace(0.1, 1, 10):
  ...
  variance_list.append("variance: {}".format(i))

show_compare_histories(path_list, name_list, variance_list)