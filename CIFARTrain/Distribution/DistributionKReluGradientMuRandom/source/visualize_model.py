...
distributions = model.conv1_1.distribution.detach().numpy()

figure, graphs = plt.subplots(4, 8)
for graph, distribution in zip(graphs.reshape(32), distributions):
...
figure.savefig("../image/distribution_trained_conv1_1.png")
