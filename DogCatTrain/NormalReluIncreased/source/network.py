...
class NormalConvolutionModelRelu(nn.Module):
  def __init__(self, image_size):
    ...
    self.batch_normalization3 = nn.BatchNorm2d(conv3_output[1])
     ...
     ## Conv4
    self.conv4_1 = NormalConvolutionLayerRelu(filters=128, kernel_size=(2, 2), input_size=conv3_output, padding=1)
    self.batch_normalization4_1 = nn.BatchNorm2d(self.conv4_1.output_size[0])
    self.conv4_2 = NormalConvolutionLayerRelu(filters=128, kernel_size=(2, 2), input_size=self.conv4_1.output_size, padding=1)
